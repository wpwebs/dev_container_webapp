# Generated by Powerlevel10k configuration wizard on 2024-05-22 at 10:29 PDT.
...
() {
  ...
  # Show user and host even if not root or in SSH
  typeset -g POWERLEVEL9K_ALWAYS_SHOW_CONTEXT=true

  # Customize the context segment (user@hostname) with different colors and transparent backgrounds
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{green}%n%f@%F{blue}%m%f'
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%F{red}%n%f@%F{blue}%m%f'
